...
export default function UserNumberCard({ numberObj, handleOpenDialog }) {
    ...
    const [country, setCountry] = React.useState(() => {
        ...
        const matchedCountry = countryData.allCountries.find(country => number.country_name_code? number.country_name_code.toLowerCase() == country.iso2 : phoneNumber.startsWith(country.dialCode)? phoneNumber.startsWith(country.dialCode) : phoneNumber.startsWith(`+${country.dialCode}`));
